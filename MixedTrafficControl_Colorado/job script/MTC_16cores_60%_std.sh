#!/bin/bash
#SBATCH --job-name=ori_std_60%    # Job name
...
#SBATCH --output=out/ori_std_60%_%j.out   # Standard output and error log
pwd; hostname; date
...
python DQN_run_std.py --rv-rate 0.6 --stop-iters 1000 --framework torch --num-cpu $SLURM_CPUS_PER_TASK
