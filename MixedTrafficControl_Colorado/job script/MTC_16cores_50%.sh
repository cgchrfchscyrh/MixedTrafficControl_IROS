#!/bin/bash
#SBATCH --job-name=ori_50%    # Job name
...
#SBATCH --output=out/ori_50%_%j.out   # Standard output and error log
pwd; hostname; date
...
python DQN_run.py --rv-rate 0.5 --stop-iters 1000 --framework torch --num-cpu $SLURM_CPUS_PER_TASK
