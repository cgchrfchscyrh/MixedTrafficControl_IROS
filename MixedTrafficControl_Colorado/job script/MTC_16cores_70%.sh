#!/bin/bash
#SBATCH --job-name=6+8_70%    # Job name
...
#SBATCH --output=out/6+8_70%_%j.out   # Standard output and error log
pwd; hostname; date
...
python DQN_run_medium_6control.py --rv-rate 0.7 --stop-iters 1000 --framework torch --num-cpu $SLURM_CPUS_PER_TASK
