#!/bin/bash
#SBATCH --job-name=86_334_60%    # Job name
...
#SBATCH --output=out/86_334_60%_%j.out   # Standard output and error log
pwd; hostname; date
...
python DQN_run_medium_334_8control.py --rv-rate 0.6 --stop-iters 1000 --framework torch --num-cpu $SLURM_CPUS_PER_TASK
