#!/bin/bash
#SBATCH --job-name=10+4_80%    # Job name
...
#SBATCH --output=out/10+4_80%_%j.out   # Standard output and error log
pwd; hostname; date
...
python DQN_run_medium_10control.py --rv-rate 0.8 --stop-iters 1000 --framework torch --num-cpu $SLURM_CPUS_PER_TASK
