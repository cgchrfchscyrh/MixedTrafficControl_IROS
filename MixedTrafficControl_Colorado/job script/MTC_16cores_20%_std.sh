#!/bin/bash
#SBATCH --job-name=ori_s20%    # Job name
...
#SBATCH --output=out/ori_s20%_%j.out   # Standard output and error log
pwd; hostname; date
...
python DQN_run_std.py --rv-rate 0.2 --stop-iters 1000 --framework torch --num-cpu $SLURM_CPUS_PER_TASK
