#!/bin/bash
#SBATCH --job-name=86_s80%    # Job name
...
#SBATCH --output=out/86_s80%_%j.out   # Standard output and error log
pwd; hostname; date
...
python DQN_run_medium_8control_std.py --rv-rate 0.8 --stop-iters 1000 --framework torch --num-cpu $SLURM_CPUS_PER_TASK
