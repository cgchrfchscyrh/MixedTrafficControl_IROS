#!/bin/bash
#SBATCH --job-name=4+10_40%    # Job name
...
#SBATCH --output=out/4+10_40%_%j.out   # Standard output and error log
pwd; hostname; date
...
python DQN_run_medium_4control.py --rv-rate 0.4 --stop-iters 1000 --framework torch --num-cpu $SLURM_CPUS_PER_TASK
