...
if __name__ == "__main__":
    ...
    for i in range(times):
        ...
        print(f"Medium_6control {rv_rate}: Evaluation {i + 1}/{times} completed: avg_wait={avg_wait}, total_arrived={total_arrived}, time={evaluation_time:.2f}s")
    ...
    print(f"\nMedium_6control_{rv_rate}: Overall Average Wait Time:")
    compute_stats(avg_wait_results, "Average Wait Time")
    print(f"\nMedium_6control_{rv_rate}: Overall Total Arrived:")
